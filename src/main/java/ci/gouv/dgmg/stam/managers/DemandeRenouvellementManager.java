...
public interface DemandeRenouvellementManager {
	...
	public abstract List<DemandeRenouvellementAgrement> getDemandeRenouvellementAgrements(long start, int step, String index);
	public abstract DemandeRenouvellementAgrement getAgrement(HttpServletRequest request, HttpServletResponse response);
	...
	public abstract List<DemandeRenouvellementPE> getDemandeRenouvellementPE(long start, int step, String index);
	public abstract DemandeRenouvellementPE getDemandeRenouvellementPE(HttpServletRequest request, HttpServletResponse response);
	...
	public abstract List<DemandeRenouvellementPR> getDemandeRenouvellement(long start, int step, String index);
	public abstract DemandeRenouvellementPR getDemandeRenouvellementPR(HttpServletRequest request, HttpServletResponse response);
	...
	public abstract List<DemandeRenouvellementProspection> getDemandeRenouvellementProspections(long start, int step, String index);
	public abstract DemandeRenouvellementProspection getDemandeRenouvellementProsptection(HttpServletRequest request, HttpServletResponse response);
