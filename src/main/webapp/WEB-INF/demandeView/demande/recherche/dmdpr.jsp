...
<l:layout title="Agrements">
	<section class = "main-section">
		<div class = "main-frame">
			<div class="frame-title">Demandes de Permis de Recherche</div>
			<div class ="bloc-items">
				...
				<nav class="nav-tools">
					<ul class="tools-list">
						<li><a href="${pageContext.servletContext.contextPath }/demandes/recherches/add" class="btn btn-add">+</a></li>
					...
					<table>
						<thead>
							<tr>
								...
								<th class = "nd-col-3">Substance</th>
								<th class = "nd-col-3">Localité</th>
								<th class = "nd-col-5">Date de soumission</th>
								<th class = "nd-col-4">Statut</th>
							</tr>
						</thead>
						<tbody>
							<c:forEach var = "dmd" items="${listeDemandePR}">
								<tr class="row" data-id="${dmd.cadastreId }">
									...
									<td class = "pe-col-3"><c:out value="${dmd.substance }"/></td>
									<td class = "pe-col-3"><c:out value="${dmd.localite }"/></td>
