...
<l:layout title="Agrements">
	<section class = "main-section">
		<div class = "main-frame">
			<div class="frame-title">Demandes d'Autorisation de  prospection</div>
			<div class ="bloc-items">
				...
				<nav class="nav-tools">
					<ul class="tools-list">
						<li><a href="${pageContext.servletContext.contextPath }/demandes/prospections/add" class="btn btn-add">+</a></li>
