...
<l:layout title="Agrements">
	<section class = "main-section">
		<div class = "main-frame">
			<div class="frame-title">Demande de renouvellement de PR</div>
			<div class ="bloc-items">
				...
				<nav class="nav-tools">
					<ul class="tools-list">
						<li><a href="${pageContext.servletContext.contextPath }/renouvellement/recherches/add" class="btn btn-add">+</a></li>
					...
					<table>
						<thead>
							<tr>
								...
								<th class = "nd-col-4">Titre</th>
							</tr>
						</thead>
						<tbody>
							<c:forEach var = "dmd" items="${listeDemandeRenouvellementPR}">
