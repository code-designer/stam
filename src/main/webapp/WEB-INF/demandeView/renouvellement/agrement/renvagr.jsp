...
<l:layout title="Agrements">
	<section class = "main-section">
		<div class = "main-frame">
			<div class="frame-title">Demandes de renouvellement d'agrement</div>
			<div class ="bloc-items">
				...
				<nav class="nav-tools">
					<ul class="tools-list">
						<li><a href="${pageContext.servletContext.contextPath }/renouvellement/agrements/add" class="btn btn-add">+</a></li>
					...
					<table>
						<thead>
							<tr>
								...
								<th class = "nd-col-3">Type activité</th>
								<th class = "nd-col-5">Date de soumission</th>
								<th class = "nd-col-4">Statut</th>
							</tr>
						</thead>
						<tbody>
							<c:forEach var = "dmd" items="${listeDemandeRenouvellementAgrements}">
								<tr class="row" data-id="${dmd.cadastreId }">
									...
									<td class = "pe-col-3"><c:out value="${dmd.typeActivite }"/></td>
